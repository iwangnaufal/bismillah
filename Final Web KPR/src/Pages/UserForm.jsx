...
export class UserForm extends Component {
  state = {
    ...
    program: '', peruntukanPembiayaan: '', nomorPenjual: '',
  ...
  handlePembiayaan = input => e => {
    ...
    } else if (e.target.value === "TakeO"){
      this.setState({isTakeO: true})
      this.setState({isTopUp: false})
      this.setState({ isProperti: false })
      this.setState({ isTakeOver: false })
      this.setState({ isPropertiKendaraan: false })
  ...
  render() {
    ...
    const { isNasabah, noRekening, jenisAgunan, luasTanah, luasBangunan, statusKepemilikan, kondisiBangunan, statusAgunan,
      ...
      isMmq, isLainProgram, isAkad, isProperti, isPropertiKendaraan, isTakeOver, isFasilitas, isBank, isYa, isKerabat, isTakeO, isTopUp,
