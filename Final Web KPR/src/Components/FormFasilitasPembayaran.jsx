...
import Stepper2 from '../stepperForm.PNG'
...
export class FasilitasPembayaran extends Component {
    ...
    render() {
        const { values, handleChange, classes, handleLainnya,
            ...
            isTakeOver, isFasilitas, isBank, isTakeO, isTopUp, step } = this.props;
        ...
        return (
            <div className="mainPage">
                <div className="mainForm">
                    ...
                    <div className="stepper" style={{marginBottom:'10px'}}>
                        <img src={Stepper2} className="stepperImage"/>
                    </div>
                    <br />
                    <br />
                    ...
                    <FormControl className={classes.formControl}>
                        ...
                        <TextField
                            ...
                            <MenuItem value="TakeO">Take Over</MenuItem>
